/* ═══════════════════════════════════════════════════════
   ...
   IDEA SCAN 2.0 — Tema Azul + Naranja
   Depende de: config.js, auth.js
   ═══════════════════════════════════════════════════════ */

'use strict';

// Ruta del ícono IDEA Scan (relativa a la raíz del proyecto)
const LOGO_SRC = 'assets/appletouchicon.png';
  ...
  sidebarEl.innerHTML = `
    <div class="sidebar-logo">
      <div class="sidebar-logo-icon">
        <img src="${LOGO_SRC}" alt="IDEA Scan" onerror="this.parentElement.textContent='📦'">
      </div>
    ...
    <div class="sidebar-user">
      ...
      <div class="sidebar-user-info">
        ...
        ${user.cliente_nombre
          ? `<div style="font-size:9px;color:rgba(255,255,255,.35);margin-top:1px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">🏢 ${user.cliente_nombre}</div>`
          : ''}
      </div>
    ...
    <div class="sidebar-footer">
      <div class="sidebar-footer-text">${APP_NAME} © 2026 · ${APP_COMPANY}</div>
    </div>`;
}
