...
const ROLE_PERMISSIONS = {
  admin:      ['config','mapa','inventario','ordenes','salidas','ai_entry','martech','reportes','paqueteria','usuarios'],
  supervisor: ['inventario','ordenes','reportes','paqueteria','mapa_asignado'],
  cliente:    ['inventario','ordenes','reportes'],
  operador:   ['inventario','ordenes','salidas','ai_entry','martech','paqueteria','mapa_asignado'],
};
...
const NAV_ITEMS = [
  ...
  { id:'paqueteria',  label:'Paquetería',       icon:'📮', href:'paqueteria.html',          roles:['admin','supervisor','operador'] },
