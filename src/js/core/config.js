...
function getNavItems(user) {
  ...
  // IA Scan (Safran): admin ve todo, usuario Safran lo ve
  // Operador sin cliente asignado también lo ve (operador interno CCA)
  // Martech NO ve IA Scan
  const esOperadorInterno = (rol === 'operador' || rol === 'supervisor') && !user?.cliente_id;
  if (esAdmin || esSafran || esOperadorInterno) {
    base.push({ id:'ai_entry',   icon:'🤖', label:'IA Scan',      href:'ai-entry.html' });
  }

  // AI Martech: admin ve todo, usuario Martech lo ve, Safran NO
