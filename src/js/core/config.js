...
function getNavItems(user) {
  ...
  const base = [
    ...
    { id:'ai_entry',   icon:'🤖', label:'IA Scan',       href:'ai-entry.html' },
    { id:'ai_martech', icon:'🟠', label:'AI Martech',    href:'ai-martech.html' },
    { id:'salidas',    icon:'📤', label:'Salidas',        href:'salidas.html' },
    { id:'paqueteria', icon:'🚚', label:'Paquetería',     href:'paqueteria.html' },
  ];
  const admin = [
  ...
  if (rol === 'admin' || rol === 'gerente') return [...base, ...admin];
  return base;
}
