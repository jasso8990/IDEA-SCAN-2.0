...
function getNavItems(user) {
  ...
  // IA Scan (Safran): admin ve todo, safran/operador-safran lo ve, martech NO
  if (esAdmin || esSafran || (!esMartech && !esCliente)) {
    base.push({ id:'ai_entry',   icon:'🤖', label:'IA Scan',      href:'ai-entry.html' });
  }

  // AI Martech: admin ve todo, martech lo ve, safran NO
